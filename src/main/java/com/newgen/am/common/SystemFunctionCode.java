...
public class SystemFunctionCode {
    ...
    public static final String MEMBER_LIMIT_CREATE_NAME = "Thiết lập hạn mức TKVD";
    ...
    public static final String APPROVAL_MEMBER_RISK_ORDER_LOCK_CREATE_CODE = "approval.memberManagement.memberRiskManagement.orderLockConfig.create";
