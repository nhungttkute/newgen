...
public class Constant {
    ...
    public static final String EXCEL_MEMBERS = "danh_sach_TVKD.xlsx";
    ...
    public static final String EXCEL_BROKERS = "danh_sach_MG.xlsx";
    public static final String CSV_COLLABORATORS = "collaborators.csv";
    public static final String EXCEL_COLLABORATORS = "danh_sach_CTVMG.xlsx";
    public static final String CSV_INVESTORS = "investors.csv";
    public static final String EXCEL_INVESTORS = "danh_sach_TKGD.xlsx";
    ...
    public static final String EXCEL_INVESTOR_MARGIN_TRANS = "DS_lich_su_GD_tien_TKGD.xlsx";
    public static final String EXCEL_ADMIN_USERS = "DS_trang_thai_dang_nhap.xlsx";
    public static final String EXCEL_INV_USER_EXCHANGES = "DS_QL_kich_hoat_gia_TKGD.xlsx";
    public static final String EXCEL_ADM_USER_EXCHANGES = "DS_QL_kich_hoat_gia_admin.xlsx";
